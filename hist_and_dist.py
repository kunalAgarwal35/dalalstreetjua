...
def get_ev_entropy(evs):
    return pd.Series([abs(ev) for ev in evs.values()]).sum()

def ev_minimized_dist(ltps,siz):
    spot = get_syn_spot(ltps)
    dist = [spot]
    l, u = 0.8*spot, 1.2*spot
    span = int(0.005*spot)
    minimum = u - span
    maximum = u
    while len(dist) <= siz:
        ...
        while minimum > l:
            ...
            extended_dist = dist + [r]
            # get evs
            evs = get_evs_from_dist(extended_dist,ltps, bidasks)
            # get ev entropy
            ev_entropy = get_ev_entropy(evs)
            if 'min_entropy' in locals():
                if ev_entropy < min_entropy:
                    min_entropy = ev_entropy
                    min_dist = extended_dist
            else:
                min_entropy = ev_entropy
                min_dist = extended_dist
...
def max_pains(ltps, siz):
    spot = get_syn_spot(ltps)
    dist = [spot]
    l, u = 0.8 * spot, 1.2 * spot
    span = int(0.005 * spot)
    spots = np.arange(l, u, 5)
    df = pd.DataFrame()
    df['spots'] = spots
    for option, ltp in ltps.items():
        df[option] = 0
    ...
    df['sum_of_returns'] = 0
    for option in ltps.keys():
           df['sum_of_returns'] = df['sum_of_returns'] + df[option]
    df.sort_values(by='sum_of_returns', inplace=True, ascending=True)
    dist = df['spots'].to_list()[:100]
    return dist
#
#
# ltps = {"11200PE": 7.75, "11300PE": 10.425, "11400PE": 14.225000000000001, "11450PE": 16.25, "11500PE": 19.225,
#         "11550PE": 22.5, "11600PE": 27.6, "11650PE": 33.125, "11700PE": 41.35, "11750PE": 49.599999999999994,
#         "11800PE": 61.15, "11850PE": 73.65, "11900PE": 89.5, "11950PE": 106.0, "12000PE": 126.425,
#         "12050PE": 150.825, "12100PE": 177.925, "12150PE": 207.375, "12200PE": 241.075, "12250PE": 279.475,
#         "12300PE": 317.175, "12350PE": 360.875, "12400PE": 404.825, "12500PE": 495.475, "12600PE": 594.2,
#         "12700PE": 690.675, "12800PE": 793.0250000000001, "12900PE": 888.175, "13000PE": 988.3, "13200PE": 1185.05,
#         "13300PE": 1283.525, "13500PE": 1484.775, "13700PE": 1677.5749999999998, "13800PE": 1783.5749999999998,
#         "10350CE": 1651.15, "10400CE": 1602.425, "10500CE": 1504.375, "10700CE": 1307.275, "10800CE": 1208.65,
#         "10900CE": 1110.675, "11000CE": 1010.0250000000001, "11200CE": 811.975, "11300CE": 717.075,
#         "11450CE": 573.875, "11500CE": 524.65, "11550CE": 482.57500000000005, "11600CE": 433.45000000000005,
#         "11650CE": 391.1, "11700CE": 349.8, "11750CE": 306.0, "11800CE": 269.2, "11900CE": 197.925,
#         "11950CE": 165.425, "12000CE": 135.3, "12050CE": 110.225, "12100CE": 87.225, "12150CE": 68.775,
#         "12200CE": 52.05, "12250CE": 39.2, "12300CE": 28.35, "12350CE": 20.0, "12400CE": 14.825, "12450CE": 11.425,
#         "12500CE": 8.425, "12550CE": 6.875, "12600CE": 5.65, "12650CE": 4.8, "12700CE": 4.35,
#         "12800CE": 3.5999999999999996}
# bidasks = {"11200PE": 0.09999999999999964, "11300PE": 0.15000000000000036, "11400PE": 0.15000000000000036,
#            "11450PE": 0.20000000000000284, "11500PE": 0.15000000000000213, "11550PE": 0.20000000000000284,
#            "11600PE": 0.09999999999999787, "11650PE": 0.25, "11700PE": 0.20000000000000284,
#            "11750PE": 0.6000000000000014, "11800PE": 0.20000000000000284, "11850PE": 0.6000000000000085,
#            "11900PE": 0.30000000000001137, "11950PE": 0.5, "12000PE": 0.25, "12050PE": 0.6500000000000057,
#            "12100PE": 0.25, "12150PE": 5.350000000000023, "12200PE": 0.8499999999999943,
#            "12250PE": 5.349999999999966, "12300PE": 2.6499999999999773, "12350PE": 14.350000000000023,
#            "12400PE": 2.25, "12500PE": 4.75, "12600PE": 6.199999999999932, "12700PE": 10.75,
#            "12800PE": 14.149999999999977, "12900PE": 41.14999999999998, "13000PE": 5.399999999999977,
#            "13200PE": 18.59999999999991, "13300PE": 15.549999999999955, "13500PE": 6.149999999999864,
#            "13700PE": 27.049999999999955, "13800PE": 11.450000000000045, "10350CE": 10.899999999999864,
#            "10400CE": 8.349999999999909, "10500CE": 5.349999999999909, "10700CE": 17.350000000000136,
#            "10800CE": 18.299999999999955, "10900CE": 21.25, "11000CE": 3.8500000000000227,
#            "11200CE": 7.0499999999999545, "11300CE": 9.949999999999932, "11450CE": 26.25,
#            "11500CE": 2.7999999999999545, "11550CE": 17.05000000000001, "11600CE": 4.199999999999989,
#            "11650CE": 6.5, "11700CE": 4.899999999999977, "11750CE": 8.5, "11800CE": 1.5,
#            "11900CE": 1.049999999999983, "11950CE": 3.049999999999983, "12000CE": 0.5999999999999943,
#            "12050CE": 0.75, "12100CE": 0.25, "12150CE": 0.45000000000000284, "12200CE": 0.19999999999999574,
#            "12250CE": 0.3999999999999986, "12300CE": 0.1999999999999993, "12350CE": 0.20000000000000284,
#            "12400CE": 0.15000000000000036, "12450CE": 0.15000000000000036, "12500CE": 0.049999999999998934,
#            "12550CE": 0.15000000000000036, "12600CE": 0.10000000000000053, "12650CE": 0.09999999999999964,
#            "12700CE": 0.10000000000000053, "12800CE": 0.10000000000000009}
#
#
# # import time
# # t1 = time.time()
...
#
# dist = ev_minimized_dist(ltps,100)
# kde = gaussian_kde(dist, bw_method='silverman').resample(size=5000)[0]
# normal_dist = np.random.normal(loc = get_syn_spot(ltps),scale = 500,size = 5000)
# # pd.Series(normal_dist).hist(bins=100)
#
# evs = get_evs_from_dist(normal_dist,ltps,bidasks)
# kde = gaussian_kde(dist, bw_method='silverman').resample(size=5000)[0]
# evs_new = get_evs_from_dist(kde,ltps,bidasks)
#
# df = pd.DataFrame()
# df['options'] = evs.keys()
# df['evs'] = evs.values()
# evnew = []
# for item in df['options']:
#     if item in evs_new.keys():
#         evnew.append(evs_new[item])
#     else:
#         evnew.append('Not Present')
# df['evs_new'] = evnew
#
# df.sort_values(by='evs',ascending=False,inplace=True)